    ...
    <el-main style="padding: 10px;">
      ...
      <el-row style="padding: 15px 0;box-shadow: 0 1px 0 0 rgba(0,0,0,0.03);">
        ...
        <el-col :span="11" style="text-align: right;">
          <el-button @click="handleDeploy" style="background: #67A0FF" type="primary">部署</el-button>
          <el-button style="background: #9B83FD" type="primary" disabled>配置</el-button>
        </el-col>
      </el-row>
      <!--组件-->
      <div is="DeployConfig"
    ...
    export default {
      ...
      methods: {
        ...
        navChange(index, item){
          ...
          // this.$api.sSetObject("_env",this.baseEnv);
