<template>
  <el-container class="devops">
    <el-aside width="190px">
      ...
      >{{item.unitName}}</div>
      <!--<div style="text-align: center;line-height: 60px;font-size: 40px;color: #DADEEE;">+</div>-->
    </el-aside>
    <el-main style="padding: 10px;">
      ...
      <el-row style="padding: 15px 0;box-shadow: 0 1px 0 0 rgba(0,0,0,0.03);">
        ...
        <el-col :span="11" style="text-align: right;">
          <el-button @click="handleDeploy" style="background: #67A0FF" type="primary"
                     v-if="!deployShow">部署</el-button>
     ...
     <!-----------------------------组件---------------------------------------->
      <div is="DeployEnv"
           ...
           :deployUnitCode="deployUnitCode"></div>
    </el-main>
    <el-dialog  title="添加环境" :visible.sync="popVisible" width="480px">
      <el-form :model="newEnv" label-width="100px">
        ...
        <el-form-item label="环境名称：" >
          <el-input v-model="newEnv.name" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="命名空间：">
          <el-input v-model="newEnv.path" placeholder="请输入内容"></el-input>
        </el-form-item>
      </el-form>
    ...
    export default {
      ...
      methods: {
        ...
        navChange(index, item){
          ...
          this.$refs.DeployEnv.historyVisible = false;
          sessionStorage.removeItem('_branch');
          this.branch = '';
          this.deployUnitId = item.unitId;
          this.deployUnitCode = item.unitName;
